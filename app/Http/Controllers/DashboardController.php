...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $links = [
            ['url' => url('/dashboard/camisetas'), 'img' => asset('/images/home/shirt.svg'), 'label' => 'Camisetas'],
            ['url' => url('/dashboard/tintas'), 'img' => asset('/images/home/paint.svg'), 'label' => 'Tintas'],
            ['url' => url('/dashboard/tecidos'), 'img' => asset('/images/home/tecido.svg'), 'label' => 'Tecidos'],
            ['url' => url('/dashboard/monitoramento'), 'img' => asset('/images/home/finance.svg'), 'label' => 'Financeiro'],
        ];
    ...
    public function envios()
    {
        ...
        $envios = Envio::whereIn('produto_id', $historicosSaida->pluck('historicoable_id'))
            ->whereIn('produto_type', $historicosSaida->pluck('historicoable_type'))
            ->first();

        return view('pages.envios', compact('historicosSaida', 'envios'));
    }
}
